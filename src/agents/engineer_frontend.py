...
from tools.npm import (
    run_npx_command,
)
from tools.tool_manager import ToolManager

SYSTEM_PROMPT = 'prompts/engineers/frontend.md'

class EngineerFrontend(Agent):
    def __init__(self, client: LLM, task_function):
        ...
        tool_manager.register_tool("run_npx_command", run_npx_command)
